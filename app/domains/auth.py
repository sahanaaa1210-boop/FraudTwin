...
def inject_landing_styles():
    st.markdown(
        ...
        .stButton.landing-btn button:hover {
...
def show_landing_page():
    ...
    st.markdown(
        ...
        <div class="landing-title">
            ...
            look like fraud.<br>
            <span class="accent">Until you know what to look for.</span>
        </div>
        """,
        unsafe_allow_html=True,
    )
    ...
    st.markdown(
        ...
        <div class="landing-sub">
            FraudTwin was built by people who spent too many nights
            staring at transaction logs, trying to explain to a boss
            why a model flagged something it couldn't explain.
            We wanted something we'd actually <b>trust</b> — and could
            actually <b>defend</b> when someone asked us why.
        </div>
        """,
        unsafe_allow_html=True,
    )
...
def render_logout_confirmation():
    ...
    st.markdown(
        ...
        <div class="logout-warning-card">
            <div class="logout-warning-title">⚠️ Confirm logout</div>
            <div class="logout-warning-text">
                Are you sure you want to sign out of your FraudTwin workspace?
                Any unsaved investigation notes on this page may be lost.
            </div>
        </div>
        """,
        unsafe_allow_html=True,
            ...
            <div class="topbar">
                <div class="topbar-left">
                    ...
                    <div>
                        ...
                        <div class="topbar-role">FraudTwin Workspace</div>
                    </div>
                </div>
            </div>
            """,
...
def render_dashboard():
    ...
    st.markdown(
        ...
        "Here's what's happening across your transaction network right now.</div>",
        unsafe_allow_html=True,
    )
...
def show_auth_page():
    ...
    with left:
        ...
        st.markdown(
            '<div class="auth-brand">FRAUD INTELLIGENCE • ANALYTICS • INVESTIGATION</div>',
            unsafe_allow_html=True,
        )
        ...
        st.markdown(
            ...
            'FraudTwin combines machine learning, contextual signals, '
            'explainable AI, attack simulation and investigation workflows '
            'into one intelligent transaction-risk platform.'
            '</div>',
            unsafe_allow_html=True,
        )

        features = [
            ("01", "Explainable AI Risk"),
            ("02", "Contextual Intelligence"),
            ("03", "What-If Simulation"),
            ("04", "Investigation & Audit"),
        ]
    ...
    with right:
        ...
        st.markdown(
            ...
            '<div class="auth-card-caption">Sign in to your risk intelligence '
            'workspace or create a new account.</div>',
            unsafe_allow_html=True,
        )
